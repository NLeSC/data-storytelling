...
} from "./chunk-ST5SCRKZ.js";
import "./chunk-CWU3XHC4.js";
import {
  fromStore
} from "./chunk-GKMBX4XV.js";
import {
  add_locations,
  append_styles,
  bind_this,
...
function Context($$anchor, $$props) {
  ...
  add_svelte_meta(() => snippet(node, () => $$props.children), "render", Context, 6, 0);
...
var root = add_locations(from_html(`<div class="s-JZDOlXZiom9z"><canvas class="s-JZDOlXZiom9z"><!></canvas></div>`), Canvas[FILENAME], [[7, 0, [[8, 2]]]]);
var $$css = {
  hash: "s-JZDOlXZiom9z",
  code: "\n  div.s-JZDOlXZiom9z {\n    position: relative;\n    width: 100%;\n    height: 100%;\n  }\n\n  canvas.s-JZDOlXZiom9z {\n    display: block;\n    position: relative;\n    width: 100%;\n    height: 100%;\n  }\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"
};
        ...
        () => Context_default(node_1, spread_props(
          ...
          () => rest,
          {
            children: wrap_snippet(Canvas, ($$anchor3, $$slotProps) => {
              ...
              add_svelte_meta(() => snippet(node_2, () => $$props.children ?? noop), "render", Canvas, 15, 8);
...
function T($$anchor, $$props) {
  ...
  var fragment = comment();
  var node = first_child(fragment);
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop, () => ({ ref: get(internalRef) })), "render", T, 92, 0);
  append($$anchor, fragment);
  return pop($$exports);
}
if (import.meta.hot) {
